                    ...
                    : userErrorHandler ? (
                        <div className="carousel-image" style={{ background: `linear-gradient(45deg, #1B262Cbb,#2c373ddd), url("/img/Penssum-cover.jpeg")` }}>
                            <div className="main-image-info-no-products">
                                <h1 className="title-carousel">Estas bloqueado :(</h1>
                                <p className="carousel-image-description">
                                    Hemos detectado que has violado las politicas del uso de Penssum, queremos hacer un ambiente
                                    sano y seguro, hemos visto que no has cumplido con las politicas del uso de Penssum, por ende
                                    esta cuenta queda bloqueada permanentemente, no podra hacer uso de Penssum por medio de esta cuenta,
                                    no podra eliminar la cuenta ni los datos registrado en la misma, de verdad disculpe las molestias 
                                    ocacionadas, pero nos hemos visto en la obligacion de bloquearlo.
                                </p>
                            </div>
                        </div>
                    ) : (
