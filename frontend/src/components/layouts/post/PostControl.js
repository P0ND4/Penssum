                    ...
                    <div className="post-control-card">
                        {offers.length > 0
                            ? offers.map((offer, index) => {
                                return (
                                    <div key={offer._id}>
                                        <OfferCard username={offer.username} name={offer.firstName} lastname={offer.lastName} offer={offer.amount} user_id={offer.user} product_id={post_id} setOffers={setOffers} offers={offers} index={index} countInMessages={countInMessages} setCountInMessages={setCountInMessages} productTitle={product.title}/>
                                    </div>
                                );
