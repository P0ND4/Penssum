...
function Quote({ obtainedFiles, setObtainedFiles, isTheUserSuspended, username, quoteId, setQuoteId }) {
    ...
    const handlerQuote = async () => {
        ...
        errorHandler.textContent = 'Copie y pegue él, id del servicio para continuar.';
        errorHandler.classList.add('showError');
        return;
    };
                    ...
                    <form onSubmit={e => e.preventDefault()}>
                        <div className="form-control ">
                            <div className="quote-file-zone">
                                ...
                                >Seleccione las Imágenes/Archivos</label>
                                <input type="file" id="quote-file" multiple hidden onChange={e => uploadFiles(e.target.files)} />
                            </div>
                        </div>
                        <div className="quote-section">
                            <div className="form-control">
                                <input id="sereal-id" type="text" placeholder="Escriba el ID de la publicación" value={quoteId} onChange={e => setQuoteId(e.target.value)} />
                            </div>
                            <div className="form-control">
                                <button 
                                    id="send-quote" 
