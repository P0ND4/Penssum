    ...
    return (
        <div className="found-container">
            {(userInformation.objetive === 'Alumno' || !auth) && (
                <div className="found">
                    <h1 className="main-data-title-found">{data.length > 0 && !error ? 'Resultado de la búsqueda' : !error ? 'Buscando...' : 'No se ha encontrado ningún profesor'}</h1>
            ...
            {userInformation.objetive === 'Profesor' && (
                <div className="found">
                    <h1 className="main-data-title-found">{data.length > 0 && !error ? 'Resultado de la búsqueda' : !error ? 'Buscando...' : 'No se ha encontrado ninguna publicación'}</h1>
