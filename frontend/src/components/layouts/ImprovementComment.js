...
function ImprovementComment({ obtainedFiles, setObtainedFiles }) {
    ...
    const checkImprovementComment = async () => {
        ...
        if (selectValue !== '-- ELIGE UN AREA --' &&
            ...
            if (improvementCommentDescription.length < 50) errorHandler.textContent = 'Describe más el área a mejorar.';
            if (improvementCommentDescription.length > 2000) errorHandler.textContent = 'No debe contener más de 2000 caracteres.';
            if (selectValue === '-- ELIGE UN AREA --') errorHandler.textContent = 'Elige el área a tocar.';
            errorHandler.classList.add('showError');
        };
    }
                ...
                <form className="improvementComment-form" onSubmit={e => e.preventDefault()}>
                    ...
                    <div className="improvementComment-divider">
                        ...
                        <select className="selectImprovement" id="selectImprovement" defaultValue="-- ELIGE UN AREA --" onChange={e => {
                            ...
                            <option value="Barra de navegacion De Usuario">Barra de navegación De Usuario</option>
                            ...
                            <option value="Publicacion de servicio">Publicación de servicio</option>
                            <option value="Seccion de inicio">Sección de inicio</option>
                            {/*<option value="Videollamada">Videollamada</option>*/}
                            <option value="Otro">Otro</option>
                        </select>
                        <div className="form-control" style={{ position: 'relative' }}>
                            <textarea placeholder="¿Cómo podemos mejorar?" id="improvementComment-description" maxLength="2000" value={improvementCommentDescription} onChange={e => {
                        ...
                        <p className="improve-warning">Advertencia: cualquier contenido obsceno podría traer como consecuencia la suspensión o el bloqueo de su cuenta.</p>
                        <div className="form-control">
                            <button 
                                id="send-improve" 
                                style={{ 
