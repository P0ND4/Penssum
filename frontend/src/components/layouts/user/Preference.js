...
function Preference({
  ...
  useEffect(() => {
    document
      .querySelectorAll(".preference-sections")
      .forEach((section) => section.classList.remove("preference-active"));
    if (window.screen.width <= 600)
      document
        .querySelector(".preference-sections-container")
        .classList.add("preference-sections-container-in-mobile");
    else
      document
        .querySelector(".preference-sections-container")
        .classList.remove("preference-sections-container-in-mobile");

    if (attribute === "mod=general")
      document
        .querySelector(".general-link")
        .classList.add("preference-active");
    if (attribute === "mod=security")
      document
        .querySelector(".security-link")
        .classList.add("preference-active");
    if (attribute === "mod=profile_information")
      document
        .querySelector(".profile-information-link")
        .classList.add("preference-active");
    if (attribute === "mod=privacy")
      document
        .querySelector(".privacy-link")
        .classList.add("preference-active");
    if (attribute === "mod=payment" && userInformation.objetive === "Profesor")
      document
        .querySelector(".payment-link")
        .classList.add("preference-active");
  });
    ...
    <div className="preference-container">
      <div className="preference">
        <div className="preference-sections-container">
          ...
          <hr />
          <Link
            to="/preference/mod=general"
            className="preference-sections general-link"
          >
            <i className="fas fa-cog"></i>
            <p>General</p>
          </Link>
          <Link
            to="/preference/mod=security"
            className="preference-sections security-link"
          >
            <i className="fas fa-shield-alt"></i>
            <p>Seguridad</p>
          </Link>
          <Link
            to="/preference/mod=profile_information"
            className="preference-sections profile-information-link"
          >
          ...
          {userInformation.objetive === "Profesor" && (
            <Link
              to="/preference/mod=payment"
              className="preference-sections payment-link"
            >
          ...
          <Link
            to="/preference/mod=privacy"
            className="preference-sections privacy-link"
          >
          ...
          {attribute === "mod=general" ? (
            <div className="commomStylePadding general">
              <PreferencePart
                ...
                typeOfUser={userInformation.objetive}
                required={true}
                requiredFor="both"
              />
              <PreferencePart
                ...
                <div className="preference-description-zone">
                  ...
                  <textarea
                    ...
                    onChange={(e) =>
                      changeDescription(
                        e,
                        "letter-count-description-preference"
                      )
                    }
            ...
            <div className="commomStylePadding profile_information">
              {userInformation.objetive === "Profesor" && (
                <div className="preference-CI-container">
                  {userInformation.identification === null && (
                    <i
                      className="fa-solid fa-circle-exclamation field-required-icon"
                      title="Campo requerido"
                    ></i>
                  ...
                  <div className="preference-CI-zone">
                    ...
                    <p className="preference-CI-description">
                      El número de identidad es para llevar el control de los
                      usuarios, también para evitar el mal uso de nuestra
                      aplicación, esto nadie lo podrá ver solo usted. (este
                      campo es obligatorio para el Profesor).
                    </p>
                  </div>
                  <button
                    id="edit-CI"
              ...
              <div
                className="preference-city-container"
              ...
              {userInformation.objetive === "Profesor" && (
                <PreferencePart
                  ...
                  value={
                    userInformation.yearsOfExperience === null
                      ? "No definido"
                      : userInformation.yearsOfExperience
                  }
              ...
              <PreferencePart
                ...
                value={
                  userInformation.phoneNumber === null
                    ? "No definido"
                ...
                >
                  <div className="preference-faculty-zone">
                    <div className="preference-faculty-information">
                      <p>Facultad</p>
                      <h4>
                        {userInformation.faculties.length === 0
                          ? "No definido"
                          : userInformation.faculties[0]}
                      </h4>
                    </div>
                    <p className="preference-faculty-description">
                      La facultad te define a qué grupo te especializas a dar
                      clases.
                    </p>
                  </div>
                  <button
                    id="edit-faculty"
                    onClick={() => {
                      document.getElementById("faculties").style.display =
                        "flex";
                      document.querySelector("body").style.overflow = "hidden";
                    }}
                  >
                ...
                <div className="dark" id="faculties">
                  <div className="dark-input">
                    ...
                    >
                      ...
                      <option value="Post universitaria">
                        Post universitaria
                      </option>
                      ...
                      <button
                        ...
                        onClick={() =>
                          changeProffesorInformation(
                            "faculties",
                            document.getElementById("filter-faculties-change")
                              .value,
                            "faculties"
                          )
                        }
              ...
              {userInformation.objetive === "Profesor" && (
                <PreferencePart
                  ...
                  value={
                    userInformation.valuePerHour === null ||
                    userInformation.valuePerHour === 0
                      ? "No definido"
                ...
                >
                  <div className="preference-subject-zone">
                    <div className="preference-subject-information">
                      ...
                      <h4>
                        {userInformation.specialty.subjects.length === 0
                          ? "No definido"
                          : userInformation.specialty.subjects}
                      </h4>
                    </div>
              ...
              <PreferenceToggle
                ...
                name="virtualClasses"
                value={userInformation.virtualClasses}
                setUserInformation={setUserInformation}
              />
              <PreferenceToggle
                ...
                value={userInformation.faceToFaceClasses}
                setUserInformation={setUserInformation}
              />
            </div>
            ...
            <div className="commomStylePadding privacy">
              <PreferenceToggle
                ...
                name="showMyNumber"
                value={userInformation.showMyNumber}
                setUserInformation={setUserInformation}
              />
            </div>
            ...
            userInformation.objetive === "Profesor" ? (
            <Link
              to="/preference/mod=payment_payu"
            ...
            >
              <div className="commomStylePadding payment">
                <section className="payment-method-help-card">
                  ...
                  <p>
                    Es una pasarela de pagos con más de 18 años de experiencia
                    en el mercado y se encargará de mediar las transacciones de
                    los clientes de tu servicio y tu banco para poder recibir
                    las ganancias.
                  </p>
                </section>
              </div>
