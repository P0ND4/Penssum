...
function Signin({
  ...
  const changeData = (e) => {
    ...
    document
      .querySelector(".login_error_registered")
    ...
    <div className="signin-container">
      <div className="signin-card">
        ...
        <form onSubmit={(e) => e.preventDefault()}>
          <p
            className="field login_error_registered"
            style={{
              textAlign: "center",
              background: "#d10b0b",
              padding: "6px",
          ...
          <div className="form-control">
            <button
              ...
              onClick={() => {
                if (!sendingInformation) verification();
              }}
            >
              Ingresar
            </button>
          ...
          <div className="form-control you-forgot-the-password">
            <Link to="/signin/recovery" id="you-forgot-the-password">
              ¿Olvidaste tu contraseña?
            </Link>
          </div>
          <div className="form-control">
            <h2 className="signInUsingTitle">O inicia sesión usando...</h2>
