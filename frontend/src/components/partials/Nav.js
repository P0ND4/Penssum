...
function Nav({
  ...
  useEffect(() => {
    socket.on("new_message", async () => {
      ...
      setCountInMessages(briefMessages.wrote);
    });
  ...
  return (
    <nav className="nav-container">
      <Link to="/" className="main-logo">
        <img src="/img/penssum-transparent.png" alt="icon-logo" /> Penssum
      </Link>
      <div
      ...
      <div className="nav-button-container">
        ...
        {auth && userInformation.typeOfUser.user !== "block" ? (
          ...
          >
            ...
            {countInMessages > 0 ? (
              <span className="user-count">
                {countInMessages > 3 ? "+3" : countInMessages}
              </span>
            ) : (
              ""
            )}
