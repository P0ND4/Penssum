            ...
            <div className="footer">
                <div className="useful-information">
                    ...
                    <ul className="footer-navigation">
                        ...
                        <li><Link className="main-footer-link" to="/help/information/mod=terms_and_conditions">TÉRMINOS Y CONDICIONES</Link></li>
                        <li><Link className="main-footer-link" to="/help/information/mod=products">SOLUCIONA RÁPIDO</Link></li>
                        ...
                        <li><Link className="main-footer-link" to="/help/information/mod=penssum">SÚMATE A PENSSUM</Link></li>
                    </ul>
                </div>
